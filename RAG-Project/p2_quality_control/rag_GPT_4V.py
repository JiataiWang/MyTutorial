...
parser.add_argument("--openai_api_key", type=str, default=", help="openai_api_kay")
...
parser.add_argument("--pair_data_path", type=str, default='/Users/titus.w/Code/data/demo_quality_control_pair', help="pair_img_text_data_path")
parser.add_argument("--text_data_path", type=str, default='/Users/titus.w/Code/data/demo_quality_control_text', help="only_text_data_path")
parser.add_argument("--embedding_model_path", type=str, default='/Users/titus.w/Code/model/bge-large-zh-v1.5', help="embedding_model_path")
